 ...
 * Validates the snakeGame moves
 *calls methods to draw grow and move snakeGame
 * draws all of the graphics to the screen
 *calls the methods ot draw and move apple
 * Use {@link moveSnake(int, int)} to move the snakeGame.
 * Use {@link BlackBackground()} to draw black background to the screen.
 * Use {@link growSnake(int)} to grow  the snakeGame.
 ...
 */
		...
		//check if the snakeGame has hit itself
	if(snake.size()>=7)	{
	...
	/**
	 *This method is called when the snakeGame has hit the wall or hit itself
	 ...
	 * Use {@link drawSnake(g)} to draw the snakeGame.
	 ...
	 */
		...
		Graphics g = null;
			...
			//snakeGame and food are drawn on to the black rectangle
			drawApple(g);
			drawSnake(g);
			Scores(g);
	...
	/** the snakeGame is  a linkedlist with Point objects
	 * the for loop, loops around every element in the linkedlist and draws  green ovals to make up the snakeGame
	...
	/** 
	 *this method moves the snakeGame around the screen
	 *@param int dx 
	 *@param int dy 
	 *it starts at the last element of the snakeGame and moves
	 ...
	 *to move the snakeGame dx and dy is added to the x and y coordinate of the head.
	  */
	 ...
	 *the getLast() gets the last point of the linkedlist in this case it would bethe tail of the snakeGame
	 *a new Point is then added to the tail to grow the snakeGame
	 *@param int n (number)
	 */
